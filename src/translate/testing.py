...
def create_action_elim_task(sas_task, plan, operator_name_to_index, ordered, enhanced, reduction, add_pos_to_goal, enhanced_fix_point, enhanced_unnecessary, use_macro_ops, scale_costs):
    ...
    for i in range(len(new_operators)):
        ...
        for j in range(len(pre_post)):
            print(pre_post[j])
            print(f"Precond: {sas_task.variables.value_names[pre_post[j][0]][pre_post[j][1]]}")
            print(f"Effects: {sas_task.variables.value_names[pre_post[j][0]][pre_post[j][2]]}")
        
        print()

    #print(f"Precond: {sas_task.variables.value_names[0][4]}")
    #print(new_operators[3].pre_post[1][2])
    ...
    #print()
    #print("Find relevant facts for action elim task")
    ...
    #print()
    #print("Prune domains of variables to only contain relevant facts")
    #print(new_variables.value_names)
    #print()
    #print(vars_vals_map)
    #print()
