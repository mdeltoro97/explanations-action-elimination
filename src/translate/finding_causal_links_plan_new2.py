...
def main():
    ...
    # TODO: How to obtain the path to this file instead of getting it manually?
    ae_sas_file_path ="/home/usuario/Descargas/action-elimination-ae-explanation/src/translate/action-elimination.sas"
    solving_ae_task(ae_sas_file_path)   

    # Determine if a plan is or not perfectly justified
    # TODO: How to obtain the path to this file instead of getting it manually?
    sas_plan_ae_path = "/home/usuario/Descargas/action-elimination-ae-explanation/src/translate/sas_plan"
